...
add_product(std_products,"ebhits_std","edm::SortedCollection<EcalRecHit,edm::StrictWeakOrdering<EcalRecHit> >","hltEgammaHLTExtra:EcalRecHitsEB")
add_product(std_products,"eehits_std","edm::SortedCollection<EcalRecHit,edm::StrictWeakOrdering<EcalRecHit> >","hltEgammaHLTExtra:EcalRecHitsEE")
...
add_product(std_products,"nrHitsEB1GeV_std","int","hltEgammaHLTExtra:countEcalRecHitsEcalRecHitsEBThres1GeV")
add_product(std_products,"nrHitsEE1GeV_std","int","hltEgammaHLTExtra:countEcalRecHitsEcalRecHitsEEThres1GeV")
add_product(std_products,"scEnergyCorrEB","vector<reco::SuperCluster>","scEnergyCorrEB")
add_product(std_products,"scEnergyCorrEE","vector<reco::SuperCluster>","scEnergyCorrEE")
add_product(std_products,"scEnergyCorrEBFeatures","edm::ValueMap<vector<float>>","scEnergyCorrEB:features")
add_product(std_products,"scEnergyCorrEEFeatures","edm::ValueMap<vector<float>>","scEnergyCorrEE:features")
